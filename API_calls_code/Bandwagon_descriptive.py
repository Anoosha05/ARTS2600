"""
Testing out the presence of Bandwagon fallacy in the first 100 tweets using a descriptive prompt
...
output_file = "Bandwagon_descriptive_results.csv"
...
def process_tweet(tweet, idx, retries=3):
    for attempt in range(retries):
        try:
            prompt = f"""You're an expert in logical reasoning. Does the tweet argue that something is true because many people believe it? Answer Yes or No with a brief explanation.
Tweet: "{tweet}"
Results:"""
