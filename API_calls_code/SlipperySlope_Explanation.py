"""
Testing out the presence of Slippery Slope in the first 100 tweets using an explanation prompt
...
output_file = "SlipperySlope_Explanation_results.csv"
...
def process_tweet(tweet, idx, retries=3):
    for attempt in range(retries):
        try:
            prompt = f"""You're an expert in logical reasoning. Does this tweet use a Slippery Slope fallacy? Answer Yes or No, and explain.
Tweet: "{tweet}"
Results:"""
