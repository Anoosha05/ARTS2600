"""
Testing out the presence of Strawman in the first 100 tweets using the explanation prompt
...
output_file = "Strawman_explanation_results.csv"
...
def process_tweet(tweet, idx, retries=3):
    for attempt in range(retries):
        try:
            prompt = f"""You're an expert in logical reasoning. Does this tweet use a Strawman fallacy? Answer Yes or No, and explain why. 
Tweet: "{tweet}"
Fallacy:"""
