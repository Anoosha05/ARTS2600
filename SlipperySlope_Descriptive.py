"""
Testing out the presence of Slippery Slope in the first 100 tweets using a descriptive prompt
...
output_file = "SlipperySlope_Descriptive_results.csv"
...
def process_tweet(tweet, idx, retries=3):
    for attempt in range(retries):
        try:
            prompt = f"""You're an expert in logical reasoning. Does the given tweet suggest that one small step will lead to extreme consequences? Answer Yes/No with an explanation.
Tweet: "{tweet}"
Results:"""
