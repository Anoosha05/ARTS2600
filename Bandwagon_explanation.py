"""
Testing out the presence of Bandwagon fallacy in the first 100 tweets using an explanation prompt
...
output_file = "Bandwagon_explanation_results.csv"
...
def process_tweet(tweet, idx, retries=3):
    for attempt in range(retries):
        try:
            prompt = f"""You're an expert in logical reasoning. Does this tweet use a Bandwagon fallacy? Answer Yes or No, and explain.
Tweet: "{tweet}"
Results:"""
