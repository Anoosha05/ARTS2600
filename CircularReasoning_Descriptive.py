"""
Testing out the presence of Circular Reasoning in the first 100 tweets using a descriptive prompt
...
output_file = "CircularReasoning_Descriptive_results.csv"
...
def process_tweet(tweet, idx, retries=3):
    for attempt in range(retries):
        try:
            prompt = f"""You're an expert in logical reasoning. Does the tweet use its conclusion as one of its premises without real evidence? Answer Yes/No with an explanation.
Tweet: "{tweet}"
Results:"""
