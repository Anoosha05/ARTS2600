"""
Testing out the presence of Hasty Generalization in the first 100 tweets using a descriptive prompt
...
output_file = "HastyGen_Descriptive_results.csv"
...
def process_tweet(tweet, idx, retries=3):
    for attempt in range(retries):
        try:
            prompt = f"""You're an expert in logical reasoning. Does the tweet make a broad claim based on limited evidence? Answer Yes/No with an explanation.
Tweet: "{tweet}"
Results:"""
