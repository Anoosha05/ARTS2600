"""
Testing out the presence of False Equivalence in the first 100 tweets using a descriptive prompt
...
output_file = "FalseEquivalence_descriptive_results.csv"
...
def process_tweet(tweet, idx, retries=3):
    for attempt in range(retries):
        try:
            prompt = f"""You're an expert in logical reasoning. Does the tweet claim two things are the same when they’re not? Answer Yes/No with a brief explanation.
Tweet: "{tweet}"
Fallacy:"""
