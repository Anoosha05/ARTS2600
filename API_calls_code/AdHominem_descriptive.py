"""
Testing out the presence of Ad Hominem in the first 100 tweets using a descriptive prompt
...
output_file = "AdHominem_descriptive_results.csv"
...
def process_tweet(tweet, idx, retries=3):
    for attempt in range(retries):
        try:
            prompt = f"""You're an expert in logical reasoning. Does the tweet attack the person rather than the argument? Answer Yes/No with a brief explanation. 
Tweet: "{tweet}"
Fallacy:"""
