"""
Testing out the presence of Ad Hominem in the first 100 tweets using an explanation prompt
...
output_file = "AdHominem_explanation_results.csv"
...
def process_tweet(tweet, idx, retries=3):
    for attempt in range(retries):
        try:
            prompt = f"""You're an expert in logical reasoning. Does this tweet use an Ad Hominem fallacy? Answer Yes or No, and explain.
Tweet: "{tweet}"
Fallacy:"""
