"""
Testing out the presence of Hasty Generalization in the first 100 tweets using an explanation prompt
...
output_file = "HastyGen_Explanation_results.csv"
...
def process_tweet(tweet, idx, retries=3):
    for attempt in range(retries):
        try:
            prompt = f"""You're an expert in logical reasoning. Does this tweet use a Hasty Generalization fallacy? Answer Yes or No, and explain.
Tweet: "{tweet}"
Results:"""
